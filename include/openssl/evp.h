...
# define EVP_PKEY_MULAN NID_mulan
# define EVP_PKEY_P256_MULAN NID_p256_mulan
# define EVP_PKEY_AIGIS NID_aigis
# define EVP_PKEY_P256_AIGIS NID_p256_aigis
#define OQS_OPENSSL_SIG_algs_length 34 //from 30 to 34 fzhang
...
#define IS_OQS_OPENSSL_SIG_NID(a) ((a >= NID_oqs_sig_default) && (a <= NID_p256_aigis)) //fzhang
