...
///// OQS_TEMPLATE_FRAGMENT_DEFINE_TLS12_SIGALGS_START
    ...
    TLSEXT_SIGALG_mulan,
    TLSEXT_SIGALG_p256_mulan,
    TLSEXT_SIGALG_aigis,
    TLSEXT_SIGALG_p256_aigis,
...
///// OQS_TEMPLATE_FRAGMENT_POPULATE_SIGALG_TBL_START
    ...
    {"rsa3072_sphincsharaka128frobust", TLSEXT_SIGALG_rsa3072_sphincsharaka128frobust,
     ...
     NID_undef, NID_undef},
    {"mulan", TLSEXT_SIGALG_mulan,
     NID_undef, -1, EVP_PKEY_MULAN, SSL_PKEY_MULAN,
     NID_undef, NID_undef},
    {"p256_mulan", TLSEXT_SIGALG_p256_mulan,
     NID_undef, -1, EVP_PKEY_P256_MULAN, SSL_PKEY_P256_MULAN,
     NID_undef, NID_undef},
    {"aigis", TLSEXT_SIGALG_aigis,
     NID_undef, -1, EVP_PKEY_AIGIS, SSL_PKEY_AIGIS,
     NID_undef, NID_undef},
    {"p256_aigis", TLSEXT_SIGALG_p256_aigis,
     NID_undef, -1, EVP_PKEY_P256_AIGIS, SSL_PKEY_P256_AIGIS,
     NID_undef, NID_undef},
...
///// OQS_TEMPLATE_FRAGMENT_MAP_SIGALG_TO_BIT_SECURITY_START
            ...
            secbits = 128;
        else if(lu->sigalg == TLSEXT_SIGALG_mulan)
            secbits = 128;
        else if(lu->sigalg == TLSEXT_SIGALG_p256_mulan)
            secbits = 128;
        else if(lu->sigalg == TLSEXT_SIGALG_aigis)
            secbits = 128;
        else if(lu->sigalg == TLSEXT_SIGALG_p256_aigis)
            secbits = 128;
...
///// OQS_TEMPLATE_FRAGMENT_ADD_CERT_CHAIN_CHECKS_START
    ...
    tls1_check_chain(s, NULL, NULL, NULL, SSL_PKEY_MULAN);
    tls1_check_chain(s, NULL, NULL, NULL, SSL_PKEY_P256_MULAN);
    tls1_check_chain(s, NULL, NULL, NULL, SSL_PKEY_AIGIS);
    tls1_check_chain(s, NULL, NULL, NULL, SSL_PKEY_P256_AIGIS);
