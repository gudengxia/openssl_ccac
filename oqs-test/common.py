...
##### OQS_TEMPLATE_FRAGMENT_SIG_ALGS_START
    ...
    'oqs_sig_default','dilithium2','dilithium3','dilithium4','falcon512','falcon1024','picnicl1full','picnic3l1','rainbowIaclassic','rainbowVcclassic','sphincsharaka128frobust','mulan', 'aigis',
    # post-quantum + classical signatures
    'p256_oqs_sig_default','rsa3072_oqs_sig_default','p256_dilithium2','rsa3072_dilithium2','p256_dilithium3','rsa3072_dilithium3','p384_dilithium4','p256_falcon512','rsa3072_falcon512','p521_falcon1024','p256_picnicl1full','rsa3072_picnicl1full','p256_picnic3l1','rsa3072_picnic3l1','p256_rainbowIaclassic','rsa3072_rainbowIaclassic','p521_rainbowVcclassic','p256_sphincsharaka128frobust','rsa3072_sphincsharaka128frobust', 'p256_mulan','p256_aigis',
